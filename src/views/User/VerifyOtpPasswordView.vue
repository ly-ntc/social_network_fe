                    ...
                    <div class="p-8">
                        ...
                        <div class="mt-6 text-center space-y-3">
                            ...
                            <RouterLink to="/forgot-password"
                                class="text-sm text-purple-600 hover:text-purple-800 transition-colors block">
...
export default {
    setup() {
        ...
        const resendCode = async () => {
            ...
            try {
                await axios.post('/api/resend-otp-reset-password/', {
                    email: email.value
                })
        ...
        const submitForm = async () => {
            ...
            try {
                const response = await axios.post('/api/verify-otp-reset-password/', {
                    email: email.value,
                    otp: otp
                })
                ...
                toastStore.showToast(5000, 'Verification successful!', 'bg-emerald-500')
